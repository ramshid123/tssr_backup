    ...
    return Scaffold(
        ...
        body: FirestoreListView(
            ...
            itemBuilder: (context, doc) {
              return doc.data()['permit_admissions']
                  ? Column(
                      children: [
                        Obx(() {
                                            ...
                                            child: Column(
                                              children: [
                                                ...
                                                kPhotoSelectionButton(
                                                    ...
                                                    compressedFile: controller
                                                        .state.photo_compressed,
                                                    file: controller
                                                        .state.photo_path),
                                                SizedBox(height: 30),
                                                kPhotoSelectionButton(
                  ...
                  : Padding(
                      ...
                      child: Center(
                        child: Text(
                          'Admissions are temporarily closed by admin.',
                          style: TextStyle(
                            fontSize: 20,
...
Widget DropDownListWidget(
  ...
  return DropdownSearch<String>(
    ...
    // This is changed to favour the dropdownlist of districts in franchise upload page. PLEASE BE NOTED
    selectedItem: value.text.isEmpty ? items[0] : value.text,
    validator: (value) {
