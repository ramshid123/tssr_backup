class AppRouteNames {
  ...
  static final TSSC_UPLOAD = '/tssc_upload';
  static final TSSC_ADMIN = '/tssc_admin';
  static final HALL_TICKET_UPLOAD = '/hall_ticket_upload';
  static final HALL_TICKET_VIEW = '/hall_ticket_page';
  static final GALLERY = '/gallery';
  static final FRANCHISE_UPLOAD = '/franchise_upload';
  static final FRANCHISE_DATA = '/franchise_data';
